# 🛡️ SHIELD - CDAC Project Review Slide Deck (Minimal White Office Theme)
...
### Slide Content
*   **Theme:** Minimal Office White (pure white background, dark charcoal text, corporate blue accents).
...
*   **Problem Formulation (Rounded Card Overlay):**
...
*   **⚙️ PIPELINE DATA FLOWCHART:**
    *   Visual architecture modeled as a neural block diagram, showing data routing through the processing steps:
        1.  **Video Frames (BGR stream)** (Muted Pink input card)
        2.  ➔ *Connects to:* **YOLOv8-Face Detection** (Muted Orange processing card)
        3.  ➔ *Connects to:* **Signal Quality Filter Gate** (Muted Yellow quality verification card)
        4.  ➔ *Splits into Parallel Inference block (3x layer stack):*
            *   **Passive Texture CNN** (Muted Teal card)
            *   **Physiological rPPG** (Muted Teal card)
            *   **Active Challenges** (Muted Teal card)
        5.  ➔ *Converges to:* **Weighted Decision Fusion** (Muted Yellow fusion card)
        6.  ➔ *Connects to:* **Linear Decision Threshold** (Muted Purple linear classifier card)
        7.  ➔ *Connects to:* **Output Verdict (Live/Spoof)** (Muted Green softmax card)

---

## Slide 4: Multimodal Verification Pillars (Rounded Cards)
...
## Slide 7: Interface Design & Live Demonstration (Rounded Cards)
