...
labeled_dir = os.path.join(docs_dir, "figures", "labeled_for_pdf")
...
for f in os.listdir(src_dir):
    if f.endswith(".mmd"):
        ...
        print(f"Rendering {name}.png with white background...")
        cmd = ["npx", "@mermaid-js/mermaid-cli", "-i", src_path, "-o", png_path, "-b", "white", "-s", "3"]
        try:
