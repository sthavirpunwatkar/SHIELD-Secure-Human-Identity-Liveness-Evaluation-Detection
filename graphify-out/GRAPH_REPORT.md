...
## Corpus Check
- 99 files · ~47,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 951 nodes · 1343 edges · 82 communities (70 shown, 12 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 124 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d4afee75`
...
Cohesion: 0.06
Nodes (36): Animation, AnimationController, Color, CustomPainter, package:flutter/services.dart, _FaceGuideOvalPainter, TickerProviderStateMixin, build (+28 more)
...
Cohesion: 0.08
Nodes (24): dart:math, bbox, build, _buildDynamicFaceGuide, _buildResultSummary, _cameras, _challengeSub, color (+16 more)
...
Cohesion: 0.11
Nodes (14): FaceDetector, Detects faces in a given frame.         :param frame: OpenCV image (BGR)., Crops a face from the frame based on a bounding box.         :param frame: OpenC, Initializes the YOLOv8 face detector.         :param model_path: Path to the YOL, inference/rppg_detector.py =========================== Real-time rPPG liveness d, Clear the signal buffer (e.g. between subjects)., Fraction of the window that is currently filled [0, 1]., Frame-by-frame rPPG liveness scorer.      Parameters     ----------     window_s (+6 more)
...
Cohesion: 0.17
Nodes (8): BenchmarkEngine, ChallengeMetrics, FASMetrics, Metrics specific to the Active Challenge-Response protocol.      Operates on a l, Calculate challenge-specific evaluation metrics.          :param challenge_resul, Calculates Anti-Spoofing Metrics.         :param y_true: List of true labels (1, ReportGenerator, main()
...
- **Why does `ChallengeSession` connect `Community 18` to `Community 34`, `Community 36`, `Community 8`, `Community 44`, `Community 16`, `Community 49`, `Community 19`, `Community 51`, `Community 55`, `Community 22`, `Community 54`, `Community 56`, `Community 25`, `Community 26`, `Community 53`?**
